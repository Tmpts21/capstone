...
<br>
                    <img class="h-65 w-65 rounded-full ring-2 ring-white" src="https://st-paul-capstone.s3.ap-southeast-1.amazonaws.com/logo/download.png" alt="">
                      <a href="https://doh.gov.ph/covid19tracker" class="mt-5 mb-5 text-white bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-7 py-4 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2">
